import FluiHeaderNav from './FluiHeaderNav.vue';
import { withDesign } from 'storybook-addon-designs'

export default {
  title: 'FlareUi/HeaderNav',
  component: FluiHeaderNav,
...
const Template = (args, { argTypes }) => ({
  ...
  components: { FluiHeaderNav },
  template: '<flui-header-nav v-bind="$props" />',
});
